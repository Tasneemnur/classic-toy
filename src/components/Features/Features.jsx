    ...
    return (
        <div className="md:mx-20 mx-3">
            ...
            <div className="grid md:grid-cols-4 grid-cols-2 gap-6 my-16">
                <div data-aos="fade-up-right" data-aos-duration="500" className="card w-full bg-base-100 shadow-xl items-center justify-center p-5"><p className="text-yellow-500 mx-auto text-5xl"><BsFillTrophyFill/></p>
                ...
                <div data-aos="zoom-in" data-aos-duration="500" className="row-span-2 col-span-2 px-28 justify-center items-center md:flex hidden">
                    <img  src={one} alt=""/>
                </div>
                <div  data-aos="fade-up-left" data-aos-duration="500" className="card w-full bg-base-100 shadow-xl items-center justify-center p-5"><p className="text-yellow-500 mx-auto text-5xl"><BsFillTagFill/></p>
                ...
                <div  data-aos="fade-down-right" data-aos-duration="500" className="card w-full bg-base-100 shadow-xl items-center justify-center p-5"><p className="text-yellow-500 mx-auto text-6xl"><CiDeliveryTruck/></p>
                ...
                <div  data-aos="fade-down-left" data-aos-duration="500" className="card w-full bg-base-100 shadow-xl items-center justify-center p-5"><p className="text-yellow-500 mx-auto text-5xl"><MdEventAvailable/></p>
